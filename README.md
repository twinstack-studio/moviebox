...
[![CI](https://github.com/twinstack-studio/parda-cinemas/actions/workflows/ci.yml/badge.svg)](https://github.com/twinstack-studio/parda-cinemas/actions/workflows/ci.yml)
[![License: All rights reserved](https://img.shields.io/badge/License-All_rights_reserved-e62a42.svg)](./LICENSE)

A movie ticket booking app for a cinema chain in Pakistan, built with Flutter
...
> **Note:** Parda Cinemas is a fictional brand created for this portfolio
> project. Cinemas, showtimes, prices and seat availability are demo data,
> payments are simulated, and the sign-in code is always `1234`.
...
```text
parda-cinemas/
├── assets/          Brand icon, splash mark and fonts
├── lib/
...
```bash
git clone https://github.com/twinstack-studio/parda-cinemas.git
cd parda-cinemas
